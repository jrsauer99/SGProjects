    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <table id="contactTable" class="table table-hover">
                        ...
                        <c:forEach var="currentLocation" items="${locationList}">
                            <tr>
                                <td>
                                    <a href="displayLocationDetails?locationID=${currentLocation.locationID}&coordinateID=${currentLocation.coordinate.coordinateID}">
                                    <c:out value="${currentLocation.locName}"/> 
                                    </a>
                                </td>
                                <td>
                                ...
                                <td>
                                    <a href="editLocationForm?locationID=${currentLocation.locationID}&coordinateID=${currentLocation.coordinate.coordinateID}">
                                        <span class="glyphicon glyphicon-edit"></span>
                                    </a>
                                </td>
                                <td>
                                    <a type="button" class="close" aria-label="Close" href="deleteLocation?locationID=${currentLocation.locationID}">
                ...
                -->
                <div class="col-md-6">
                    <h2 class="col-md-offset-1">Add Location</h2>
